...
// });
    ...
    it('should get user by id', () => {
        ...
        expect(mockResponse.send).toHaveBeenCalledWith({ id: 2, username: "jack", displayName: "Jack", password: "hello124" });
...
describe("create users", () => {
    const mockRequest = {};
    it("should return status of 400 when ther are errors", async () => {
